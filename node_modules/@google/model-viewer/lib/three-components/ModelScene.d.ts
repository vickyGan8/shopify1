import { AnimationActionLoopStyles, AnimationMixerEventMap, Box3, Camera, Event as ThreeEvent, Material, Mesh, Object3D, PerspectiveCamera, Scene, Sphere, Texture, ToneMapping, Vector2, Vector3, WebGLRenderer, XRTargetRaySpace } from 'three';
import { CSS2DRenderer } from 'three/examples/jsm/renderers/CSS2DRenderer.js';
import ModelViewerElementBase, { EffectComposerInterface, RendererInterface } from '../model-viewer-base.js';
import { ModelViewerElement } from '../model-viewer.js';
import { ModelViewerGLTFInstance } from './gltf-instance/ModelViewerGLTFInstance.js';
import { Hotspot } from './Hotspot.js';
import { Shadow } from './Shadow.js';
export declare const GROUNDED_SKYBOX_SIZE = 10;
...
export declare class ModelScene extends Scene {
    ...
    url: string | null;
    pivot: Object3D<import("three").Object3DEventMap>;
    ...
    bakedShadows: Set<Mesh<import("three").BufferGeometry<import("three").NormalBufferAttributes, import("three").BufferGeometryEventMap>, Material | Material[], import("three").Object3DEventMap>>;
    exposure: number;
    ...
    setBackground(skybox: Texture | null): void;
    farRadius(): number;
    ...
    get model(): Object3D<import("three").Object3DEventMap> | null;
    /**
    ...
    getHit(object?: Object3D): import("three").Intersection<Object3D<import("three").Object3DEventMap>> | undefined;
    hitFromController(controller: XRTargetRaySpace, object?: Object3D): import("three").Intersection<Object3D<import("three").Object3DEventMap>> | undefined;
    hitFromPoint(ndcPosition: Vector2, object?: Object3D): import("three").Intersection<Object3D<import("three").Object3DEventMap>> | undefined;
    /**
